...
## 01. УСТАНОВКА ПРОШИВКИ
- Системные требования
- Подготовка
- Запуск и процесс установки

## 02. ПОДКЛЮЧЕНИЕ И НАСТРОЙКА
- Подготовка микроконтроллера
- Подключение к плате PS5
- Настройка контроллера
- Веб-интерфейс монитора

## 03. ИНСТРУКЦИЯ ПО ЭКСПЛУАТАЦИИ
### 3.1. Главный экран
### 3.2. Описание кольца индикации
### 3.3. Режимы работы
  - MANUAL (Ручной режим)
  - OFFSET (Режим смещения)
  - TARGET (Стабилизация температуры)
  - GRAPH (Режим кривой)
### 3.4. Редактор кривой (GRAPH EDITOR)
### 3.5. Управление статистикой и графиком
### 3.6. Верхние значки (системные настройки)
  - Переключение темы
  - Настройки Wi-Fi
  - Индикатор I2C (датчик температуры)
  - Advanced Settings (AS)
  - Переключение режима управления (SC / PS5)
### 3.7. Сброс и перезагрузка
### 3.8. Техническая поддержка

## 04. ДОПОЛНИТЕЛЬНАЯ ПЛАТА
- Назначение платы
- Как установить плату на ESP32-C3 Mini
- Подключение датчика температуры и вентилятора через плату
- Проверка перед включением
- Возможные проблемы и решения
- Заключение

## 05. ЧАСТО ЗАДАВАЕМЫЕ ВОПРОСЫ (FAQ)
