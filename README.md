...
# PS5 SMART COOLER - Навигация

- [УСТАНОВКА ПРОШИВКИ](#установка-прошивки)
  - [Системные требования](#системные-требования)
  - [Подготовка](#подготовка)
  - [Запуск и процесс установки](#запуск-и-процесс-установки)

- [ПОДКЛЮЧЕНИЕ И НАСТРОЙКА](#подключение-и-настройка)
  - [1. Подготовка микроконтроллера](#1-подготовка-микроконтроллера)
  - [2. Подключение к плате PS5](#2-подключение-к-плате-ps5)
  - [3. Настройка контроллера](#3-настройка-контроллера)
  - [4. Веб-интерфейс монитора](#4-веб-интерфейс-монитора)

- [ИНСТРУКЦИЯ ПО ЭКСПЛУАТАЦИИ](#инструкция-по-эксплуатации)
  - [1. Главный экран](#1-главный-экран)
  - [2. Описание кольца индикации](#2-описание-кольца-индикации)
  - [3. Режимы работы (доступны в платной версии)](#3-режимы-работы-доступны-в-платной-версии)
    - [3.1 MANUAL (Ручной режим)](#31-manual-ручной-режим)
    - [3.2 OFFSET (Режим смещения)](#32-offset-режим-смещения)
    - [3.3 TARGET (Стабилизация температуры)](#33-target-стабилизация-температуры)
    - [3.4 GRAPH (Режим кривой)](#34-graph-режим-кривой)
  - [4. Редактор кривой (GRAPH EDITOR)](#4-редактор-кривой-graph-editor)
  - [5. Управление статистикой и графиком](#5-управление-статистикой-и-графиком)
  - [6. Верхние значки (системные настройки)](#6-верхние-значки-системные-настройки)
    - [6.1 Переключение темы](#61-переключение-темы-- )
    - [6.2 Настройки Wi-Fi](#62-настройки-wi-fi-)
    - [6.3 Индикатор I2C (датчик температуры)](#63-индикатор-i2c-датчик-температуры)
    - [6.4 Advanced Settings (AS)](#64-advanced-settings-as)
    - [6.5 Переключение режима управления (SC / PS5)](#65-переключение-режима-управления-sc--ps5)
  - [7. Сброс и перезагрузка](#7-сброс-и-перезагрузка)
  - [8. Техническая поддержка](#8-техническая-поддержка)

- [ДОПОЛНИТЕЛЬНАЯ ПЛАТА](#дополнительная-плата)
  - [1. Назначение платы](#1-назначение-платы)
  - [2. Как установить плату на ESP32-C3 Mini](#2-как-установить-плату-на-esp32-c3-mini)
  - [3. Подключение датчика температуры и вентилятора через плату](#3-подключение-датчика-температуры-и-вентилятора-через-плату)
  - [4. Проверка перед включением](#4-проверка-перед-включением)
  - [5. Возможные проблемы и решения](#5-возможные-проблемы-и-решения)
